...
# qpOASES
sqp_solver.setOption("qp",QPOasesSolver)
sqp_solver.setOption("qp_options",{"printLevel" : "low"})

# OOQP
#sqp_solver.setOption("qp",OOQpSolver)
...
#qp_solver.setOption("nlp", IpoptSolver)
