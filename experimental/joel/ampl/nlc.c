...
static void funnelwalk(funnel *f){
  cplist *cl;
  dLR *d;
  int k;
...
static void cde_dwalk(cde *d, int n, maxinfo *m, list **ifset, int **z, cgrad **cgp){
  cde *De;
...
int main(int argc, char **argv){
  argc = 3;
  char *argv2[] = {"./nlc","-l","../examples/cork.nl"};
  printf("entry point!\n");
  printf("argc = %d!\n",argc);
  FILE *nl;
  char *s, *s0;
