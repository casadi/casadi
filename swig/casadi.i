...
%casadi_typemaps2("str", PREC_STRING, std::string)
%casadi_template("[str]", PREC_STRING, std::vector<std::string>)
%casadi_typemaps2("Sparsity", PREC_SPARSITY, casadi::Sparsity)
