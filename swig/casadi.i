...
%casadi_template("[(str,SX)]", PREC_SXVector, std::vector<std::pair<std::string, casadi::Matrix<casadi::SXElement> > >)
...
%casadi_template("[(str,MX)]", PREC_MXVector, std::vector<std::pair<std::string, casadi::MX> >)
...
%casadi_template("[(str,DMatrix)]", PREC_DMatrixVector, std::vector<std::pair<std::string, casadi::Matrix<double> > >)
