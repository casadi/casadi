...
|                   | L      |                                                 |
+-------------------+--------+-------------------------------------------------+
| print_maxit_reach | OT_BOO | Print error when maximum number of SQP          |
| ed                | L      | iterations reached                              |
+-------------------+--------+-------------------------------------------------+
| qp_init           | OT_BOO | Use warmstarting                                |
|                   | L      |                                                 |
+-------------------+--------+-------------------------------------------------+
...
|                   | L      |                                                 |
+-------------------+--------+-------------------------------------------------+
| rho               | OT_DOU | Feasibility restoration phase parameter         |
|                   | BLE    |                                                 |
+-------------------+--------+-------------------------------------------------+
...
+-------------------+--------+-------------------------------------------------+
| zeta              | OT_DOU | Feasibility restoration phase parameter         |
|                   | BLE    |                                                 |
+-------------------+--------+-------------------------------------------------+
