...
autogenmetadatahpp = file(os.path.join(os.curdir,"..","casadi","symbolic","function","schemes_metadata.hpp~"),"w")
autogenhelpershpp = file(os.path.join(os.curdir,"..","casadi","symbolic","function","schemes_helpers.hpp~"),"w")
autogenpy = file(os.path.join(os.curdir,"..","swig","autogenerated.i~"),"w")
autogencpp = file(os.path.join(os.curdir,"..","casadi","symbolic","function","schemes_metadata.cpp~"),"w")
...
autogenpy.write("""%include "casadi/symbolic/function/schemes_metadata.hpp"\n%include "casadi/symbolic/function/schemes_helpers.hpp"\n""")
...
import filecmp
for f in [
  os.path.join(os.curdir,"..","casadi","symbolic","function","schemes_metadata.hpp"),
  os.path.join(os.curdir,"..","casadi","symbolic","function","schemes_helpers.hpp"),
  os.path.join(os.curdir,"..","swig","autogenerated.i"),
  os.path.join(os.curdir,"..","casadi","symbolic","function","schemes_metadata.cpp")
  ]:
  if not filecmp.cmp(f+"~",f):
    os.remove(f)
    os.rename(f+"~",f)
