...
class ADtests(casadiTestCase):
  ...
  def test_MX(self):
    ...
    for inputs,values,out, jac in [
          ...
          (in1,v1,mulold(y,x,Sparsity.triplet(2,1,[1],[0])),y[Sparsity.triplet(2,2,[1,1],[0,1])]),
          (in1,v1,mulold(x.T,y.T,Sparsity.triplet(2,1,[1],[0]).T),y[Sparsity.triplet(2,2,[1,1],[0,1])]),
