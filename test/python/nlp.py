...
class NLPtests(casadiTestCase):
  def testIPOPT(self):
    ...
    for Solver in solvers:
      ...
      solver.solve()
      self.assertAlmostEqual(solver.output(NLP_SOLVER_F)[0],0,10,str(Solver))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_X)[0],1,9,str(Solver))
      self.assertAlmostEqual(solver.output(NLP_G)[0],1,9,str(Solver))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_LAM_X)[0],0,9,str(Solver))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_LAM_G)[0],0,9,str(Solver))
  ...
  def testIPOPTinf(self):
    ...
    for Solver in solvers:
      ...
      solver.solve()
      self.assertAlmostEqual(solver.output(NLP_SOLVER_F)[0],0,10,str(Solver))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_X)[0],1,7,str(Solver) + str(solver.output(NLP_SOLVER_X)[0]-1))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_LAM_X)[0],0,9,str(Solver))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_LAM_G)[0],0,9,str(Solver))
  ...
  def testIPOPTrb(self):
    ...
    for Solver in solvers:
      ...
      solver.solve()
      self.assertAlmostEqual(solver.output(NLP_SOLVER_F)[0],0,10,str(Solver))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_X)[0],1,7,str(Solver))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_X)[1],1,7,str(Solver))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_LAM_X)[0],0,9,str(Solver))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_LAM_X)[1],0,9,str(Solver))
  ...
  def testIPOPTrb2(self):
    ...
    for Solver in solvers:
      ...
      self.assertAlmostEqual(solver.output(NLP_SOLVER_F)[0],0,digits,str(Solver))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_X)[0],1,digits,str(Solver))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_X)[1],1,digits,str(Solver))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_LAM_X)[0],0,9,str(Solver))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_LAM_X)[1],0,9,str(Solver))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_LAM_G)[0],0,9,str(Solver))
    ...
    for Solver in solvers:
      ...
      for k,v in ({"tol":1e-8,"TolOpti":1e-20,"hessian_approximation":"limited-memory","max_iter":100, "MaxIter": 100,"print_level":0,"derivative_test":"first-order","qp_solver": qpsolver,"qp_solver_options" : qpsolver_options}).iteritems():
        if solver.hasOption(k):
          solver.setOption(k,v)
      solver.init()
      solver.input(NLP_SOLVER_X0).set([0,1])
      ...
      self.assertAlmostEqual(solver.output(NLP_SOLVER_X)[0],1,7,str(Solver))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_X)[1],1,7,str(Solver))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_LAM_X)[0],0,6,str(Solver))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_LAM_X)[1],0,6,str(Solver))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_LAM_G)[0],0,6,str(Solver))
  ...
  def testIPOPTrhb2(self):
    ...
    for Solver in solvers:
      ...
      solver.init()
      solver.input(NLP_SOLVER_X0).set([0.5,0.5])
      solver.input(NLP_LBX).set([-10]*2)
      solver.input(NLP_UBX).set([10]*2)
      ...
      self.assertAlmostEqual(solver.output(NLP_SOLVER_F)[0],c_r,digits,str(Solver))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_X)[0],x_r[0],digits,str(Solver))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_X)[1],x_r[1],digits,str(Solver))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_LAM_X)[0],0,8,str(Solver))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_LAM_X)[1],0,8,str(Solver))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_LAM_G)[0],0.12149655447670,6,str(Solver))
    ...
    solver.input(NLP_LBG).set([0])
    solver.input(NLP_UBG).set([1])
    solver.input(NLP_SOLVER_X0).set(oldsolver.output(NLP_SOLVER_X))
    solver.input(NLP_SOLVER_LAM_X0).set(oldsolver.output(NLP_SOLVER_LAM_G))
    solver.output(NLP_SOLVER_LAM_X).set(oldsolver.output(NLP_SOLVER_LAM_X))
  ...
  def testIPOPTrhb2_gen(self):
    ...
    for Solver in solvers:
      ...
      self.assertAlmostEqual(solver.output(NLP_SOLVER_F)[0],c_r,digits,str(Solver) + str(solver.output(NLP_SOLVER_F)[0]) + ":" + str(c_r))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_X)[0],x_r[0],digits,str(Solver))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_X)[1],x_r[1],digits,str(Solver))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_LAM_X)[0],0,8,str(Solver))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_LAM_X)[1],0,8,str(Solver))
  ...
  def testIPOPTrhb(self):
    ...
    for Solver in solvers:
      ...
      self.assertAlmostEqual(solver.output(NLP_SOLVER_F)[0],0,10,str(Solver))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_X)[0],1,9,str(Solver))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_X)[1],1,9,str(Solver))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_LAM_X)[0],0,8,str(Solver))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_LAM_X)[1],0,8,str(Solver))
  ...
  def testIPOPTrhb_gen_xnonfree(self):
    ...
    for Solver in solvers:
      ...
      self.assertAlmostEqual(solver.output(NLP_SOLVER_F)[0],0,10,str(Solver))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_X)[0],1,9,str(Solver))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_X)[1],1,6,str(Solver))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_LAM_X)[0],0,6,str(Solver))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_LAM_X)[1],0,6,str(Solver))
  ...
  def testIPOPTnorm(self):
    ...
    for Solver in solvers:
      ...
      solver.solve()
      print "residuals"
      print array(solver.output(NLP_SOLVER_X)).squeeze()-x0
      self.assertAlmostEqual(solver.output(NLP_SOLVER_F)[0],0,10,str(Solver))
      self.checkarray(array(solver.output(NLP_SOLVER_X)).squeeze(),x0,str(Solver))
      self.checkarray(solver.output(NLP_SOLVER_LAM_X),DMatrix([0]*10),8,str(Solver),digits=8)
      self.assertAlmostEqual(solver.output(NLP_SOLVER_LAM_G)[1],0,8,str(Solver))
  ...
  def testIPOPTc(self):
    ...
    for Solver in solvers:
      ...
      solver.solve()
      self.assertAlmostEqual(solver.output(NLP_SOLVER_F)[0],0,9,str(Solver) )
      self.assertAlmostEqual(solver.output(NLP_SOLVER_X)[0],1,9,str(Solver))
  ...
  def testIPOPTc2(self):
    ...
    for Solver in solvers:
      ...
      solver.solve()
      self.assertAlmostEqual(solver.output(NLP_SOLVER_F)[0],0,10,str(Solver))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_X)[0],1,8,str(Solver))
  ...
  def testIPOPTdeg(self):
    ...
    g=SXFunction([vertcat([x,y])],[vertcat([x-y,x])])
    ...
    for Solver in solvers:
      ...
      solver.solve()
      self.assertAlmostEqual(solver.output(NLP_SOLVER_X)[0],solver.output(NLP_SOLVER_X)[1],10,"IPOPT")
  ...
  def testactiveLBX(self):
    ...
    for Solver in solvers:
      ...
      solver.init()
      solver.input(NLP_SOLVER_X0).set([0,1])
      solver.input(NLP_LBX).set([-10,1.2])
      solver.input(NLP_UBX).set([10,2])
      solver.input(NLP_LBG).set([-10])
      solver.input(NLP_UBG).set([10])
      solver.solve()
      self.assertAlmostEqual(solver.output(NLP_SOLVER_F)[0],9.0908263002590e-3,6,str(Solver))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_X)[0],1.0952466252248,6,str(Solver))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_X)[1],1.2,5,str(Solver))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_LAM_X)[0],0,8,str(Solver))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_LAM_X)[1],-8.6963632695079e-2,4,str(Solver))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_LAM_G)[0],0,8,str(Solver))
  ...
  def testactiveLBG(self):
    ...
    for Solver in solvers:
      ...
      solver.input(NLP_LBX).set([-10,-10])
      solver.input(NLP_UBX).set([10,10])
      solver.input(NLP_LBG).set([2.2])
      solver.input(NLP_UBG).set([10])
      solver.solve()
      self.assertAlmostEqual(solver.output(NLP_SOLVER_F)[0],4.252906468284e-3,6,str(Solver))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_X)[0],1.065181061847138,6,str(Solver))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_X)[1],1.1348189166291160,6,str(Solver))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_LAM_X)[0],0,8,str(Solver))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_LAM_X)[1],0,4,str(Solver))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_LAM_G)[0],-4.1644422845712e-2,3,str(Solver))
  ...
  def testactiveUBG(self):
    ...
    for Solver in solvers:
      ...
      solver.solve()
      self.assertAlmostEqual(solver.output(NLP_SOLVER_F)[0],4.64801220074552e-3,6,str(Solver))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_X)[0],9.318651964592811e-1,5,str(Solver))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_X)[1],8.68134821123689e-1,5,str(Solver))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_LAM_X)[0],0,8,str(Solver))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_LAM_X)[1],0,4,str(Solver))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_LAM_G)[0],4.75846495145007e-2,5,str(Solver))
  ...
  def testactiveUBX(self):
    ...
    for Solver in solvers:
      ...
      solver.init()
      solver.input(NLP_SOLVER_X0).set([0,1])
      solver.input(NLP_LBX).set([-10,0])
      solver.input(NLP_UBX).set([10,0.9])
      solver.input(NLP_LBG).set([-10])
      solver.input(NLP_UBG).set([10])
      solver.solve()
      self.assertAlmostEqual(solver.output(NLP_SOLVER_F)[0],2.626109721583e-3,6,str(Solver))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_X)[0],9.4882542279172277e-01,6,str(Solver))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_X)[1],0.9,6,str(Solver))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_LAM_X)[0],0,8,str(Solver))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_LAM_X)[1],5.39346608659e-2,4,str(Solver))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_LAM_G)[0],0,8,str(Solver))
  ...
  def test_QP(self):
    ...
    for Solver in solvers:
      ...
      solver.solve()
      self.checkarray(solver.output(NLP_SOLVER_X),x0,str(Solver),digits=2)
      self.assertAlmostEqual(solver.output(NLP_SOLVER_F)[0],0,3,str(Solver))
      self.checkarray(solver.output(NLP_SOLVER_LAM_X),DMatrix.zeros(N,1),str(Solver),digits=4)
  ...
  def test_tol_pr(self):
    ...
    for Solver in solvers:
      ...
      self.assertAlmostEqual(solver.output(NLP_SOLVER_LAM_X)[0],4.75,6,str(qpsolver))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_LAM_X)[1],0,6,str(qpsolver))

      self.checkarray(solver.output(NLP_SOLVER_LAM_G),DMatrix([0,2,0]),str(qpsolver),digits=6)
      
      self.assertAlmostEqual(solver.output(NLP_SOLVER_F)[0],-7.4375,6,str(qpsolver))
  ...
  def test_QP2_unconvex(self):
    ...
    for Solver in solvers:
      ...
      self.assertAlmostEqual(solver.output(NLP_SOLVER_LAM_X)[0],0,6,str(qpsolver))
      self.assertAlmostEqual(solver.output(NLP_SOLVER_LAM_X)[1],0,6,str(qpsolver))

      self.checkarray(solver.output(NLP_SOLVER_LAM_G),DMatrix([4+8.0/9,20.0/9,0]),str(qpsolver),digits=6)
      
      self.assertAlmostEqual(solver.output(NLP_SOLVER_F)[0],-10-16.0/9,6,str(qpsolver))
