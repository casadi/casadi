...
class DocStrings(casadiTestCase):
  ...
  def test_5(self):
    doc = ca.collocation_interpolators.__doc__ or ""
    self.assertTrue("A collocation method" in doc)

  def test_6(self):
    doc = ca.adj.__doc__ or ""
    self.assertTrue("Matrix adjoint" in doc)

  def test_7(self):
    doc = ca.taylor.__doc__ or ""
    self.assertTrue("sin(x)" in doc)
    
  def test_8(self):
    doc = ca.erfinv.__doc__ or ""
