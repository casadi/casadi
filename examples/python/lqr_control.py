...
sim.setOption("integrator_options", {"fsens_err_con": True,"reltol":1e-12,"stop_at_end":False})
sim.setOption("nf",20)
sim.init()
...
sim = ControlSimulator(cdae,out,tn)
sim.setOption("integrator", CVodesIntegrator)
sim.setOption("integrator_options", {"fsens_err_con": True,"reltol":1e-8,"stop_at_end":False})
sim.setOption("nf",20)
sim.init()
