...
Many of the above operations are also defined for the \texttt{Sparsity} class (Section~\ref{sec:sparsity_class}), e.g. \texttt{vertcat}, \texttt{horzsplit}, \emph{transposing}, addition -- returning the \emph{union} of two sparsity patterns -- and multiplication -- returning the \emph{intersection} of two sparsity patterns.
