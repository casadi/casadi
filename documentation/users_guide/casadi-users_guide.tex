...
For more operations, we invite to search the API documentation or look at the documented examples:
...
\section{Calculus}
Basic calculus operations are also possibly and implemented very efficiently using \emph{algorithmic differentiation} (AD) as outlined in Chapter~\ref{ch:ad}.
\begin{pytex}
A = SX.sym("A",3,3)
x = SX.sym("x",3)
