...
All derived classes of \texttt{FX} come with a range of options that can be set. The API documentation shows the list of available options, along with their default values and descriptions.
...
Again check the API documentation for details. For example, here is an excerpt from the documentation for the constructor of a \texttt{IpoptSolver}:
\begin{pytexoutput}
