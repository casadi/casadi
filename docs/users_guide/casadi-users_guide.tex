...
\subsection*{Number of available memory objects}
\begin{lstlisting}[language=C]
int fname_n_memory(void);
\end{lstlisting}
...
The function \verb|fname_n_mem| returns the number of available memory objects
or -1 if there is no upper bound.
