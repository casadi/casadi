...
\paragraph{Solver}
You must always declare the \texttt{solver} (numerical backend).
...
To warmstart a solver, you need to explicitly transfer the solution of one problem to the initial value of the next.
\begin{lstlisting}[language=Python]
sol1 = opti.solve()
