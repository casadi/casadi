...
options are ``main'', which generates a \emph{main} entry point, and ``mex'',
...
This enables executing the function from the command line and MATLAB/Octave, respectively, as described in the following section.
