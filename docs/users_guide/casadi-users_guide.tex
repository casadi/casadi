...
\begin{itemize}
  ...
  \item Optional functions for derivatives. You can choose to supply a full Jacobian (\verb|has_jacobian|, \verb|get_jacobian|), or choose to supply forward/reverse sensitivities (\verb|has_forward|, \verb|get_forward|,  \verb|get_n_reverse|, \verb|get_reverse|).
\end{itemize}
