...
int main(){
  ...
  cout << setw(30) << "Objective: " << res.at("f") << std::endl;
  cout << setw(30) << "Primal solution: " << res.at("x") << std::endl;
  cout << setw(30) << "Dual solution (x): " << res.at("lam_x") << std::endl;
  cout << setw(30) << "Dual solution (g): " << res.at("lam_g") << std::endl;
