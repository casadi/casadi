...
<tr><td>output_scheme</td><td>OT_STRINGVECTOR</td><td>Custom output scheme</td><td>casadi::FunctionInternal</td></tr>
<tr><td>parallelization</td><td>OT_STRING</td><td>Computational strategy for parallelization: serial|openmp</td><td>casadi::MapBase</td></tr>
...
<tr><td>jit_options</td><td>OT_DICT</td><td>Options to be passed to the jit compiler.</td><td>casadi::FunctionInternal</td></tr>
<tr><td>monitor</td><td>OT_STRINGVECTOR</td><td>Monitors to be activated</td><td>casadi::FunctionInternal</td></tr>
<tr><td>n_threads</td><td>OT_INT</td><td>Control the number of threads when executing in parallel. The default setting (0) will pass the decision on to the parallelization library. For openmp, this means that OMP_NUM_THREADS env. variable is observed.</td><td>casadi::MapReduce</td></tr>
<tr><td>output_scheme</td><td>OT_STRINGVECTOR</td><td>Custom output scheme</td><td>casadi::FunctionInternal</td></tr>
<tr><td>parallelization</td><td>OT_STRING</td><td>Computational strategy for parallelization: serial|openmp</td><td>casadi::MapReduce</td></tr>
...
<tr><td>output_scheme</td><td>OT_STRINGVECTOR</td><td>Custom output scheme</td><td>casadi::FunctionInternal</td></tr>
<tr><td>parallelization</td><td>OT_STRING</td><td>Computational strategy for parallelization: serial|openmp</td><td>casadi::MapSerial</td></tr>
