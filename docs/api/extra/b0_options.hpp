...
<tr><td>"gather_stats"</td><td>OT_BOOLEAN</td><td>false</td><td>"Flag to indicate wether statistics must be gathered"</td><td>casadi::FunctionInternal</td></tr>
...
<tr><td>"ad_mode"</td><td>OT_STRING</td><td>"automatic"</td><td>"How to calculate the Jacobians." ("forward: only forward mode|reverse: only adjoint mode|automatic: a heuristic decides which is more appropriate")</td><td>casadi::FunctionInternal</td></tr>
<tr><td>"contype"</td><td>OT_INTEGERVECTOR</td><td></td><td></td><td>casadi::SnoptInternal</td></tr>
<tr><td>"derivative_generator"</td><td>OT_DERIVATIVEGENERATOR</td><td>GenericType()</td><td>"and reverse directional derivative, overrides internal routines. Check documentation of DerivativeGenerator."</td><td>casadi::FunctionInternal</td></tr>
<tr><td>"expand"</td><td>OT_BOOLEAN</td><td>false</td><td>"Expand the NLP function in terms of scalar operations, i.e. MX->SX"</td><td>casadi::NLPSolverInternal</td></tr>
<tr><td>"expand_f"</td><td>OT_BOOLEAN</td><td>GenericType()</td><td>"Expand the objective function in terms of scalar operations, i.e. MX->SX. Deprecated, use \"expand\" instead."</td><td>casadi::NLPSolverInternal</td></tr>
<tr><td>"expand_g"</td><td>OT_BOOLEAN</td><td>GenericType()</td><td>"Expand the constraint function in terms of scalar operations, i.e. MX->SX. Deprecated, use \"expand\" instead."</td><td>casadi::NLPSolverInternal</td></tr>
...
<tr><td>"_penalty"</td><td>OT_REAL</td><td>1e5</td><td>"parameter heavily influences the ability of DSDP to treat linear equalities. The DSDP standard default (1e8) will make a problem with linear equality return unusable solutions."</td><td>casadi::DSDPInternal</td></tr>
...
<tr><td>"qp_ipBarrier"</td><td>OT_REAL</td><td>worhp_p_.qp.ipBarrier</td><td>"IP barrier parameter."</td><td>casadi::WorhpInternal</td></tr>
<tr><td>"qp_ipComTol"</td><td>OT_REAL</td><td>worhp_p_.qp.ipComTol</td><td>"IP complementarity tolerance."</td><td>casadi::WorhpInternal</td></tr>
<tr><td>"qp_ipFracBound"</td><td>OT_REAL</td><td>worhp_p_.qp.ipFracBound</td><td>"IP fraction-to-the-boundary parameter."</td><td>casadi::WorhpInternal</td></tr>
...
<tr><td>"qp_ipMinAlpha"</td><td>OT_REAL</td><td>worhp_p_.qp.ipMinAlpha</td><td>"IP line search minimum step size."</td><td>casadi::WorhpInternal</td></tr>
<tr><td>"qp_ipRelaxDiv"</td><td>OT_REAL</td><td>worhp_p_.qp.ipRelaxDiv</td><td>"The relaxation term is divided by this value if successful."</td><td>casadi::WorhpInternal</td></tr>
<tr><td>"qp_ipRelaxMax"</td><td>OT_REAL</td><td>worhp_p_.qp.ipRelaxMax</td><td>"Maximum relaxation value."</td><td>casadi::WorhpInternal</td></tr>
<tr><td>"qp_ipRelaxMin"</td><td>OT_REAL</td><td>worhp_p_.qp.ipRelaxMin</td><td>"Mimimum relaxation value."</td><td>casadi::WorhpInternal</td></tr>
<tr><td>"qp_ipRelaxMult"</td><td>OT_REAL</td><td>worhp_p_.qp.ipRelaxMult</td><td>"The relaxation term is multiplied by this value if unsuccessful."</td><td>casadi::WorhpInternal</td></tr>
<tr><td>"qp_ipResTol"</td><td>OT_REAL</td><td>worhp_p_.qp.ipResTol</td><td>"IP residuals tolerance."</td><td>casadi::WorhpInternal</td></tr>
<tr><td>"qp_ipTryRelax"</td><td>OT_BOOLEAN</td><td>worhp_p_.qp.ipTryRelax</td><td>"Enable relaxation strategy when encountering an error."</td><td>casadi::WorhpInternal</td></tr>
<tr><td>"qp_lsItMaxIter"</td><td>OT_INTEGER</td><td>worhp_p_.qp.lsItMaxIter</td><td>"Maximum number of iterations of the iterative linear solvers."</td><td>casadi::WorhpInternal</td></tr>
...
<tr><td>"qp_lsRefineMaxIter"</td><td>OT_INTEGER</td><td>worhp_p_.qp.lsRefineMaxIter</td><td>"Maximum number of iterative refinement steps of the direct linear solvers."</td><td>casadi::WorhpInternal</td></tr>
<tr><td>"qp_lsScale"</td><td>OT_BOOLEAN</td><td>worhp_p_.qp.lsScale</td><td>"Enables scaling on linear solver level."</td><td>casadi::WorhpInternal</td></tr>
<tr><td>"qp_lsTol"</td><td>OT_REAL</td><td>worhp_p_.qp.lsTol</td><td>"Tolerance for the linear solver."</td><td>casadi::WorhpInternal</td></tr>
<tr><td>"qp_lsTrySimple"</td><td>OT_BOOLEAN</td><td>worhp_p_.qp.lsTrySimple</td><td>"Some matrices can be solved without calling a linear equation solver.Currently only diagonal matrices are supported. Non-diagonal matrices will besolved with the chosen linear equation solver."</td><td>casadi::WorhpInternal</td></tr>
...
<tr><td>"qp_nsnBeta"</td><td>OT_REAL</td><td>worhp_p_.qp.nsnBeta</td><td>"NSN stepsize decrease factor."</td><td>casadi::WorhpInternal</td></tr>
<tr><td>"qp_nsnGradStep"</td><td>OT_BOOLEAN</td><td>worhp_p_.qp.nsnGradStep</td><td>"Enable gradient steps in the NSN method."</td><td>casadi::WorhpInternal</td></tr>
<tr><td>"qp_nsnKKT"</td><td>OT_REAL</td><td>worhp_p_.qp.nsnKKT</td><td>"NSN KKT tolerance."</td><td>casadi::WorhpInternal</td></tr>
...
<tr><td>"qp_nsnMinAlpha"</td><td>OT_REAL</td><td>worhp_p_.qp.nsnMinAlpha</td><td>"NSN line search minimum step size."</td><td>casadi::WorhpInternal</td></tr>
<tr><td>"qp_nsnSigma"</td><td>OT_REAL</td><td>worhp_p_.qp.nsnSigma</td><td>"NSN line search slope parameter."</td><td>casadi::WorhpInternal</td></tr>
...
<tr><td>ad_mode</td><td>OT_STRING</td><td>automatic</td><td>How to calculate the Jacobians.</td><td>casadi::WorhpInternal</td></tr>
<tr><td>derivative_generator</td><td>OT_DERIVATIVEGENERATOR</td><td>None</td><td>Function that returns a derivative function given a number of forward and reverse directional derivative, overrides internal routines. Check documentation of DerivativeGenerator.</td><td>casadi::WorhpInternal</td></tr>
...
<tr><td>expand_f</td><td>OT_BOOLEAN</td><td>None</td><td>Expand the objective function in terms of scalar operations, i.e. MX->SX. Deprecated, use "expand" instead.</td><td>casadi::WorhpInternal</td></tr>
<tr><td>expand_g</td><td>OT_BOOLEAN</td><td>None</td><td>Expand the constraint function in terms of scalar operations, i.e. MX->SX. Deprecated, use "expand" instead.</td><td>casadi::WorhpInternal</td></tr>
...
<tr><td>generate_gradient</td><td>OT_BOOLEAN</td><td>None</td><td>Deprecated option. Generate a function for calculating the gradient of the objective.</td><td>casadi::WorhpInternal</td></tr>
...
<tr><td>generate_jacobian</td><td>OT_BOOLEAN</td><td>None</td><td>Deprecated option. Generate an exact Jacobian of the constraints if not supplied.</td><td>casadi::WorhpInternal</td></tr>
<tr><td>grad_f</td><td>OT_Function</td><td>None</td><td>Function for calculating the gradient of the objective (column, autogenerated by default)</td><td>casadi::WorhpInternal</td></tr>
<tr><td>grad_lag</td><td>OT_Function</td><td>None</td><td>Function for calculating the gradient of the Lagrangian (autogenerated by default)</td><td>casadi::WorhpInternal</td></tr>
<tr><td>hess_lag</td><td>OT_Function</td><td>None</td><td>Function for calculating the Hessian of the Lagrangian (autogenerated by default)</td><td>casadi::WorhpInternal</td></tr>
...
<tr><td>inputs_check</td><td>OT_BOOLEAN</td><td>True</td><td>Throw exceptions when the numerical values of the inputs don't make sense</td><td>casadi::WorhpInternal</td></tr>
...
<tr><td>iteration_callback</td><td>OT_CALLBACK</td><td>None</td><td>A function that will be called at each iteration with the solver as input. Check documentation of Callback.</td><td>casadi::WorhpInternal</td></tr>
...
<tr><td>jac_f</td><td>OT_Function</td><td>None</td><td>Function for calculating the jacobian of the objective (sparse row, autogenerated by default)</td><td>casadi::WorhpInternal</td></tr>
<tr><td>jac_g</td><td>OT_Function</td><td>None</td><td>Function for calculating the Jacobian of the constraints (autogenerated by default)</td><td>casadi::WorhpInternal</td></tr>
<tr><td>monitor</td><td>OT_STRINGVECTOR</td><td>None</td><td>Monitors to be activated<br />Monitor functions</td><td>casadi::WorhpInternal</td></tr>
<tr><td>name</td><td>OT_STRING</td><td>unnamed_shared_object</td><td>n/a</td><td>casadi::WorhpInternal</td></tr>
<tr><td>parametric</td><td>OT_BOOLEAN</td><td>None</td><td>Deprecated option. Expect F, G, H, J to have an additional input argument appended at the end, denoting fixed parameters.</td><td>casadi::WorhpInternal</td></tr>
<tr><td>print_time</td><td>OT_BOOLEAN</td><td>True</td><td>Print information about execution time</td><td>casadi::WorhpInternal</td></tr>
...
<tr><td>"name"</td><td>OT_STRING</td><td>"unnamed_shared_object"</td><td>name of the object</td><td>casadi::OptionsFunctionalityNode</td></tr>
<tr><td>"parametric"</td><td>OT_BOOLEAN</td><td>GenericType()</td><td>"Deprecated option. Expect F, G, H, J to have an additional input argument appended at the end, denoting fixed parameters."</td><td>casadi::NLPSolverInternal</td></tr>
<tr><td>"pass_nonlinear_variables"</td><td>OT_BOOLEAN</td><td>false</td><td></td><td>casadi::IpoptInternal</td></tr>
...
<tr><td>derivative_generator</td><td>OT_DERIVATIVEGENERATOR</td><td>None</td><td>Function that returns a derivative function given a number of forward and reverse directional derivative, overrides internal routines. Check documentation of DerivativeGenerator.</td><td>casadi::IpoptInternal</td></tr>
...
<tr><td>expand_f</td><td>OT_BOOLEAN</td><td>None</td><td>Expand the objective function in terms of scalar operations, i.e. MX->SX. Deprecated, use "expand" instead.</td><td>casadi::IpoptInternal</td></tr>
<tr><td>expand_g</td><td>OT_BOOLEAN</td><td>None</td><td>Expand the constraint function in terms of scalar operations, i.e. MX->SX. Deprecated, use "expand" instead.</td><td>casadi::IpoptInternal</td></tr>
...
<tr><td>generate_gradient</td><td>OT_BOOLEAN</td><td>None</td><td>Deprecated option. Generate a function for calculating the gradient of the objective.</td><td>casadi::IpoptInternal</td></tr>
...
<tr><td>generate_jacobian</td><td>OT_BOOLEAN</td><td>None</td><td>Deprecated option. Generate an exact Jacobian of the constraints if not supplied.</td><td>casadi::IpoptInternal</td></tr>
<tr><td>grad_f</td><td>OT_Function</td><td>None</td><td>Function for calculating the gradient of the objective (column, autogenerated by default)</td><td>casadi::IpoptInternal</td></tr>
<tr><td>grad_lag</td><td>OT_Function</td><td>None</td><td>Function for calculating the gradient of the Lagrangian (autogenerated by default)</td><td>casadi::IpoptInternal</td></tr>
<tr><td>hess_lag</td><td>OT_Function</td><td>None</td><td>Function for calculating the Hessian of the Lagrangian (autogenerated by default)</td><td>casadi::IpoptInternal</td></tr>
...
<tr><td>inputs_check</td><td>OT_BOOLEAN</td><td>True</td><td>Throw exceptions when the numerical values of the inputs don't make sense</td><td>casadi::IpoptInternal</td></tr>
<tr><td>iteration_callback</td><td>OT_CALLBACK</td><td>None</td><td>A function that will be called at each iteration with the solver as input. Check documentation of Callback.</td><td>casadi::IpoptInternal</td></tr>
...
<tr><td>jac_f</td><td>OT_Function</td><td>None</td><td>Function for calculating the jacobian of the objective (sparse row, autogenerated by default)</td><td>casadi::IpoptInternal</td></tr>
<tr><td>jac_g</td><td>OT_Function</td><td>None</td><td>Function for calculating the Jacobian of the constraints (autogenerated by default)</td><td>casadi::IpoptInternal</td></tr>
...
<tr><td>monitor</td><td>OT_STRINGVECTOR</td><td>None</td><td>Monitors to be activated</td><td>casadi::IpoptInternal</td></tr>
...
<tr><td>parametric</td><td>OT_BOOLEAN</td><td>None</td><td>Deprecated option. Expect F, G, H, J to have an additional input argument appended at the end, denoting fixed parameters.</td><td>casadi::IpoptInternal</td></tr>
...
<tr><td>"gather_stats"</td><td>OT_BOOLEAN</td><td>false</td><td>"Flag to indicate wether statistics must be gathered"</td><td>casadi::FunctionInternal</td></tr>
<tr><td>"initialStatusBounds"</td><td>OT_STRING</td><td>SubjectToStatus_to_string</td><td>"inactive::all bounds inactive|lower::all bounds active at their lower bound|upper::all bounds active at their upper bound"</td><td>casadi::QPOasesInternal</td></tr>
<tr><td>"inputs_check"</td><td>OT_BOOLEAN</td><td>true</td><td>"Throw exceptions when the numerical values of the inputs don't make sense"</td><td>casadi::FunctionInternal</td></tr>
<tr><td>"monitor"</td><td>OT_STRINGVECTOR</td><td>GenericType()</td><td>"Monitors to be activated" ("inputs|outputs")</td><td>casadi::FunctionInternal</td></tr>
