...
<tr><td>"qp_lsItPrecondMethod"</td><td>OT_STRING</td><td>GenericType()</td><td>"none:No preconditioner.:0|static:Static preconditioner (KKT-matrix with constant lower-right block).:1|full:Full KKT-matrix.:2"</td><td>casadi::WorhpInternal</td></tr>
...
<tr><td>"qp_lsTrySimple"</td><td>OT_BOOLEAN</td><td>worhp_p_.qp.lsTrySimple</td><td>"Currently only diagonal matrices are supported.Non-diagonal matrices will besolved with the chosen linear equation solver."</td><td>casadi::WorhpInternal</td></tr>
<tr><td>"qp_maxIter"</td><td>OT_INTEGER</td><td>worhp_p_.qp.maxIter</td><td>" i.e. for the quadratic subproblem solver.If the limit is reached before convergence,WORHP will activate QP recovery strategies to prevent a solver breakdown."</td><td>casadi::WorhpInternal</td></tr>
<tr><td>"qp_method"</td><td>OT_STRING</td><td>GenericType()</td><td>"ip:Interior-Point method.:1|nsn:Nonsmooth-Newton method.:2|automatic: Prefer IP and fall back to NSN on error.:12"</td><td>casadi::WorhpInternal</td></tr>
...
<tr><td>"qp_nsnLsMethod"</td><td>OT_STRING</td><td>GenericType()</td><td>"SuperLU::2|MA48: only available if provided by the user:4"</td><td>casadi::WorhpInternal</td></tr>
...
<tr><td>"qp_printLevel"</td><td>OT_STRING</td><td>GenericType()</td><td>"none:No output.:0|warn:Print warnings and errors.:1|iterations:Print iterations.:2"</td><td>casadi::WorhpInternal</td></tr>
