...
<a name='schemes'></a><table>
<caption>Input scheme: casadi::ConicInput  (CONIC_NUM_IN = 15)</caption>
<tr><th>Full name</th><th>Short</th><th>Description</th></tr>
...
<tr><td>CONIC_Q</td><td>q</td><td>The matrix Q: sparse symmetric, (nq^2 x n)</td></tr>
<tr><td>CONIC_P</td><td>p</td><td>The matrix P: sparse symmetric, (nq x nq)</td></tr>
</table>
*/
