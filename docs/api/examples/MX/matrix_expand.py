...
#! We can use SX.fun to expand into subexpressions
...
#! The expanded SX graph is hidden inside an SX.fun graph call
...
#! Note how the additions is not expanded, while the multiplication ended up in the SX.fun
