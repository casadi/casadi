...
namespace CasADi{
  ...
  std::pair<FX,FX> IntegratorInternal::getAugmented(int nfwd, int nadj, IntegratorInternal::AugOffset& offset){
    ...
    MX aug_x = msym("aug_x",offset.x.back(),f_.input(DAE_X).size2());
    MX aug_z = msym("aug_z",offset.z.back(),f_.input(DAE_Z).size2());
    MX aug_p = msym("aug_p",offset.p.back(),f_.input(DAE_P).size2());
    MX aug_rx = msym("aug_rx",offset.rx.back(),f_.input(DAE_X).size2());
    MX aug_rz = msym("aug_rz",offset.rz.back(),f_.input(DAE_Z).size2());
    MX aug_rp = msym("aug_rp",offset.rp.back(),f_.output(DAE_QUAD).size2());
