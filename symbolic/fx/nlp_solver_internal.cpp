...
namespace CasADi{
  ...
  NLPSolverInternal::NLPSolverInternal(const FX& nlp) : nlp_(nlp){
    ...
    addOption("iteration_callback", OT_CALLBACK, GenericType(),  "A function that will be called at each iteration. Input scheme is the same as NLPSolver's output scheme. Output is scalar.");
