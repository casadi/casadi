...
namespace CasADi{
  ...
  NLPSolverInternal::NLPSolverInternal(const FX& nlp, const FX& F, const FX& G) : nlp_(nlp), F_(F), G_(G){
    ...
    addOption("hes_lag",           OT_FX,       GenericType(),  "Function for calculating the Hessian of the Lagrangian (autogenerated by default)"); 
    ...
    addOption("hessian_mode",      OT_STRING,   "bfgs",         "Type of Hessian", "exact|bfgs|gauss_newton");
  ...
  FX NLPSolverInternal::getJacG(){
    ...
    jacG.setOption("name","nlp_jacobian");
    jacG.init(false);
    log("Jacobian function initialized");
    return jacG;
  }

  FX NLPSolverInternal::getHesLag(){
    FX hesLag;
    if(hasSetOption("hes_lag")){
      hesLag = getOption("hes_lag");
    } else {
      ...
      log("Generating Hessian");
      hesLag = lag_fcn.jacobian(NL_X,NL_NUM_OUT+NL_X,false,true);
      log("Hessian function generated");
    }
    hesLag.setOption("name","nlp_hessian");
    hesLag.init(false);
    log("Hessian function initialized");
    return hesLag;
  }
  ...
  FX NLPSolverInternal::getGradF(){
    ...
    gradF.setOption("name","nlp_jacobian");
    gradF.init(false);
    log("Jacobian function initialized");
    return gradF;
  }
