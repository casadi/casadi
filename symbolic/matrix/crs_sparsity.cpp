...
namespace CasADi{
  ...
  CRSSparsity CRSSparsity::patternCombine(const CRSSparsity& y, vector<unsigned char>& mapping, bool f00_is_zero, bool f0x_is_zero, bool fx0_is_zero) const{
    return (*this)->patternCombine(y, mapping, f00_is_zero, f0x_is_zero, fx0_is_zero);
  }

  CRSSparsity CRSSparsity::patternIntersection(const CRSSparsity& y, vector<unsigned char>& mapping) const{
    return (*this)->patternCombine(y, mapping, true, true, true);
  }
