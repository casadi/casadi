...
std::string getSchemeEntryNames(InputOutputScheme scheme) {
  switch (scheme) {
    ...
    case SCHEME_OCPInput: return "t, lbx, ubx, x_init, lbu, ubu, u_init, lbp, ubp, p_init, lbh, ubh, lbg, ubg";
...
std::string getSchemeEntryName(InputOutputScheme scheme, int i) {
  switch (scheme) {
    ...
    case SCHEME_OCPInput: 
      ...
      if(i==4) return "lbu";
      if(i==5) return "ubu";
      if(i==6) return "u_init";
      if(i==7) return "lbp";
      if(i==8) return "ubp";
      if(i==9) return "p_init";
      if(i==10) return "lbh";
      if(i==11) return "ubh";
      if(i==12) return "lbg";
      if(i==13) return "ubg";
      casadi_error("getSchemeEntryName: supplied number is out of range. OCPInput has only 14 entries: ('OCPInput', 't, lbx, ubx, x_init, lbu, ubu, u_init, lbp, ubp, p_init, lbh, ubh, lbg, ubg')");
      break;
...
std::string getSchemeEntryDoc(InputOutputScheme scheme, int i) {
  switch (scheme) {
    ...
    case SCHEME_OCPInput: 
      ...
      if(i==4) return "Controls lower bounds (nu x ns)";
      if(i==5) return "Controls upper bounds (nu x ns)";
      if(i==6) return "Controls initial guess (nu x ns)";
      if(i==7) return "Parameters lower bounds (np x 1)";
      if(i==8) return "Parameters upper bounds (np x 1)";
      if(i==9) return "Parameters initial guess (np x 1)";
      if(i==10) return "Point constraint lower bound (nh x (ns+1))";
      if(i==11) return "Point constraint upper bound (nh x (ns+1))";
      if(i==12) return "Lower bound for the coupling constraints";
      if(i==13) return "Upper bound for the coupling constraints";
      casadi_error("getSchemeEntryDoc: supplied number is out of range. OCPInput has only 14 entries: ('OCPInput', 't, lbx, ubx, x_init, lbu, ubu, u_init, lbp, ubp, p_init, lbh, ubh, lbg, ubg')");
      break;
    case SCHEME_OCPOutput: 
...
std::string getSchemeEntryEnumName(InputOutputScheme scheme, int i) {
  switch (scheme) {
    ...
    case SCHEME_OCPInput: 
      ...
      if(i==4) return "OCP_LBU";
      if(i==5) return "OCP_UBU";
      if(i==6) return "OCP_U_INIT";
      if(i==7) return "OCP_LBP";
      if(i==8) return "OCP_UBP";
      if(i==9) return "OCP_P_INIT";
      if(i==10) return "OCP_LBH";
      if(i==11) return "OCP_UBH";
      if(i==12) return "OCP_LBG";
      if(i==13) return "OCP_UBG";
      casadi_error("getSchemeEntryEnumName: supplied number is out of range. OCPInput has only 14 entries: ('OCPInput', 't, lbx, ubx, x_init, lbu, ubu, u_init, lbp, ubp, p_init, lbh, ubh, lbg, ubg')");
      break;
    case SCHEME_OCPOutput: 
...
int getSchemeEntryEnum(InputOutputScheme scheme, const std::string &name) {
  switch (scheme) {
    ...
    case SCHEME_OCPInput: 
      ...
      if(name=="lbu") return 4;
      if(name=="ubu") return 5;
      if(name=="u_init") return 6;
      if(name=="lbp") return 7;
      if(name=="ubp") return 8;
      if(name=="p_init") return 9;
      if(name=="lbh") return 10;
      if(name=="ubh") return 11;
      if(name=="lbg") return 12;
      if(name=="ubg") return 13;
      break;
    case SCHEME_OCPOutput: 
      if(name=="x_opt") return 0;
      if(name=="u_opt") return 1;
