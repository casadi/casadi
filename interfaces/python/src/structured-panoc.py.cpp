...
struct dict_to_struct_table<alpaqa::StructuredPANOCLBFGSParams<Conf>> {
    inline static const dict_to_struct_table_t<alpaqa::StructuredPANOCLBFGSParams<Conf>> table{
        // clang-format off
