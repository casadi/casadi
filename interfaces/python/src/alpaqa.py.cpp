...
void register_classes_for(py::module_ &m) {
    ...
    py::class_<LipschitzEstimateParams>(
        ...
        .def_readwrite("L_0", &LipschitzEstimateParams::L₀)
    ...
    py::class_<ALMParams>(m, "ALMParams", "C++ documentation: :cpp:class:`alpaqa::ALMParams`")
        ...
        .def_readwrite("Σ_0", &ALMParams::Σ₀)
        .def_readwrite("σ_0", &ALMParams::σ₀)
        .def_readwrite("Σ_0_lower", &ALMParams::Σ₀_lower)
        .def_readwrite("ε_0", &ALMParams::ε₀)
        .def_readwrite("ε_0_increase", &ALMParams::ε₀_increase)
