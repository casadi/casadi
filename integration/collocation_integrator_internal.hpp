...
public:
  ...
  /// Constructor
  explicit CollocationIntegratorInternal(const FX& f);
  ...
  virtual CollocationIntegratorInternal* create(const FX& f) const{ return new CollocationIntegratorInternal(f);}
