...
class ScalarMatrixOp : public MXNode{
  public:
    ...
    virtual void evaluate(const vDMatrixP& input, DMatrix& output, const vvDMatrixP& fwdSeed, vDMatrixP& fwdSens, const vDMatrixP& adjSeed, vvDMatrixP& adjSens, int nfwd, int nadj);
