...
namespace casadi {
  ...
  extern "C"
  int CASADI_NONLINEAR_PROGRAMMING_EXPORT casadi_register_nlpsolver_sqpmethod(NLPSolver::Plugin* plugin){
  ...
  extern "C"
  void CASADI_NONLINEAR_PROGRAMMING_EXPORT casadi_load_nlpsolver_sqpmethod(){
