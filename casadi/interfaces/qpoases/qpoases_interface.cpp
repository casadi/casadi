...
namespace casadi {
  ...
  extern "C"
  int CASADI_QP_QPOASES_EXPORT
  casadi_register_qp_qpoases(QpSolverInternal::Plugin* plugin) {
  ...
  extern "C"
  void CASADI_QP_QPOASES_EXPORT casadi_load_qp_qpoases() {
    QpSolverInternal::registerPlugin(casadi_register_qp_qpoases);
  }
