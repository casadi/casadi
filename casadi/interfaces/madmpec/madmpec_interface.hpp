...
class CASADI_NLPSOL_MADMPEC_EXPORT MadmpecInterface : public Nlpsol {
 public:
  ...
  explicit MadmpecInterface(const std::string& name, const Function& nlp);
  ...
  static Nlpsol* creator(const std::string& name, const Function& nlp) {
    return new MadmpecInterface(name, nlp);
  }
  ...
  void* alloc_mem() const override { return new MadmpecMemory();}
  ...
  static ProtoFunction* deserialize(DeserializingStream& s) { return new MadmpecInterface(s); }

 protected:
  /** \brief Deserializing constructor */
  explicit MadmpecInterface(DeserializingStream& s);
