...
"|     Id      |         Type          |            Description             |\n"
"+=============+=======================+====================================+\n"
"| compute_iis | OT_BOOL               | Compute IIS right after an         |\n"
"|             |                       | infeasible solve and expose via     |\n"
"|             |                       | get_stats() [Default true].        |\n"
"+-------------+-----------------------+------------------------------------+\n"
"| log_file    | OT_STRING             | Write solver log to this path via  |\n"
"|             |                       | XPRSsetlogfile [Default: disabled] |\n"
"+-------------+-----------------------+------------------------------------+\n"
"| mip_start   | OT_BOOL               | Pass x0 as an initial integer      |\n"
"|             |                       | solution hint via XPRSaddmipsol    |\n"
"|             |                       | [Default false].                   |\n"
"+-------------+-----------------------+------------------------------------+\n"
