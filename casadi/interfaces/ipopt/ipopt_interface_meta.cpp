...
"\n"
"For a good tutorial on IPOPT, see https://drops.dagstuhl.de/storage/16dagstuhl-seminar-proceedings/dsp-\n"
...
"|                          |               | tolerance *                   |\n"
"|                          |               | inactive_lam_value|abstol:    |\n"
"|                          |               | use inactive_lam_value        |\n"
"+--------------------------+---------------+-------------------------------+\n"
...
"|                          |               | (autogenerated by default)    |\n"
"+--------------------------+---------------+-------------------------------+\n"
"| max_iter_eig             | OT_DOUBLE     | Maximum number of iterations  |\n"
"|                          |               | to compute an eigenvalue      |\n"
"|                          |               | decomposition (default: 50).  |\n"
"+--------------------------+---------------+-------------------------------+\n"
"| nonlinear_variables      | OT_BOOLVECTOR | Which decision variables      |\n"
"|                          |               | enter nonlinearly? (detected  |\n"
"|                          |               | automatically by default)     |\n"
"+--------------------------+---------------+-------------------------------+\n"
"| pass_nonlinear_variables | OT_BOOL       | Pass list of variables        |\n"
"|                          |               | entering nonlinearly to IPOPT |\n"
"+--------------------------+---------------+-------------------------------+\n"
