...
namespace casadi {
  ...
  extern "C"
  int CASADI_NLP_IPOPT_EXPORT
  casadi_register_nlp_ipopt(NlpSolverInternal::Plugin* plugin) {
  ...
  extern "C"
  void CASADI_NLP_IPOPT_EXPORT casadi_load_nlp_ipopt() {
    NlpSolverInternal::registerPlugin(casadi_register_nlp_ipopt);
  }
