...
void CvodesInterface::calc_daeF(CvodesMemory* m, double t, const double* x, const double* z,
...
void CvodesInterface::calc_daeB(CvodesMemory* m, double t, const double* x, const double* z,
...
void CvodesInterface::calc_quadF(CvodesMemory* m, double t, const double* x, const double* z,
    double* quad) const {
  m->arg[DAEF_X] = x;  // x
  m->arg[DAEF_Z] = z;  // z
  m->arg[DAEF_P] = m->p;  // p
...
void CvodesInterface::calc_quadB(CvodesMemory* m, double t, const double* x, const double* z,
