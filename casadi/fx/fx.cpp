...
CRSSparsity& FX::jacSparsityOld(int iind, int oind){
  return (*this)->jacSparsityOld(iind,oind);
}

void FX::setJacSparsityOld(const CRSSparsity& sp, int iind, int oind){
  (*this)->setJacSparsityOld(sp,iind,oind);
}
