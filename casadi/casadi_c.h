...
CASADI_EXPORT int casadi_c_alloc_mem(void);
CASADI_EXPORT void casadi_c_free_mem(int mem);
CASADI_EXPORT int casadi_c_init_mem(int mem);
...
CASADI_EXPORT int casadi_c_alloc_mem_id(int id);
CASADI_EXPORT void casadi_c_free_mem_id(int id, int mem);
CASADI_EXPORT int casadi_c_init_mem_id(int id, int mem);
