 ...
 */
      ...
      const std::string casadi::SimpleIndefDpleInternal::meta_doc=
      "\n"
"\n"
...
"|                 |                 |                 | appropriate)    |\n"
"+-----------------+-----------------+-----------------+-----------------+\n"
"| const_dim       | OT_BOOLEAN      | true            | Assume constant |\n"
"|                 |                 |                 | dimension of P  |\n"
"+-----------------+-----------------+-----------------+-----------------+\n"
...
"|                 |                 |                 | detection       |\n"
"+-----------------+-----------------+-----------------+-----------------+\n"
"| error_unstable  | OT_BOOLEAN      | false           | Throw an        |\n"
"|                 |                 |                 | exception when  |\n"
"|                 |                 |                 | it is detected  |\n"
"|                 |                 |                 | that            |\n"
"|                 |                 |                 | Product(A_i,    |\n"
...
"|                 |                 | _object\"        | object          |\n"
"+-----------------+-----------------+-----------------+-----------------+\n"
"| pos_def         | OT_BOOLEAN      | false           | Assume P        |\n"
"|                 |                 |                 | positive        |\n"
"|                 |                 |                 | definite        |\n"
"+-----------------+-----------------+-----------------+-----------------+\n"
