...
namespace casadi {
  ...
  /** \brief ControlSimulator data storage class
      ...
      \date 2010
  */
  class CASADI_EXPORT ControlSimulatorInternal : public FunctionInternal {
  public:
    ...
    virtual size_t get_n_in() const { return CONTROLSIMULATOR_NUM_IN;}
    virtual size_t get_n_out() const { return output_fcn_.n_out()-2;}
    ///@}

    /// @{
    /** \brief Sparsities of function inputs and outputs */
    virtual Sparsity get_sparsity_in(int ind) const { return Sparsity();}
    virtual Sparsity get_sparsity_out(int ind) const { return Sparsity();}
    /// @}
