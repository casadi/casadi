...
namespace casadi {
  ...
  Nlsol::Nlsol(const std::string& name, const Function& f)
  ...
  void Nlsol::init() {
    ...
    casadi_assert_message(
      ...
      "Nlsol::init: singularity - the jacobian is structurally rank-deficient. "
  ...
  const std::string Nlsol::infix_ = "nlsol";
