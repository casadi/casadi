...
namespace casadi {
  ...
  void NormF::eval_mx(const std::vector<MX>& arg, std::vector<MX>& res, bool unique) const {
    res[0] = arg[0]->get_norm_fro();
  }

  void Norm1::eval_mx(const std::vector<MX>& arg, std::vector<MX>& res, bool unique) const {
    res[0] = arg[0]->get_norm_1();
  }

  void NormInf::eval_mx(const std::vector<MX>& arg, std::vector<MX>& res, bool unique) const {
    res[0] = arg[0]->get_norm_inf();
  }

  void Norm2::eval_mx(const std::vector<MX>& arg, std::vector<MX>& res, bool unique) const {
