...
namespace casadi {
  ...
  template<bool Add>
  void SetNonzerosVector<Add>::evalD(void* mem, const double** arg, double** res,
                                     int* iw, double* w) {
    evalGen<double>(mem, arg, res, iw, w);
  }

  template<bool Add>
  void SetNonzerosVector<Add>::evalSX(void* mem, const SXElem** arg, SXElem** res,
                                      int* iw, SXElem* w) {
  ...
  template<bool Add>
  template<typename T>
  void SetNonzerosVector<Add>::evalGen(void* mem, const T** arg, T** res,
                                       int* iw, T* w) {
  ...
  template<bool Add>
  void SetNonzerosSlice<Add>::evalD(void* mem, const double** arg, double** res,
                                    int* iw, double* w) {
    evalGen<double>(mem, arg, res, iw, w);
  }

  template<bool Add>
  void SetNonzerosSlice<Add>::evalSX(void* mem, const SXElem** arg, SXElem** res,
                                     int* iw, SXElem* w) {
    evalGen<SXElem>(mem, arg, res, iw, w);
  }
  ...
  template<bool Add>
  template<typename T>
  void SetNonzerosSlice<Add>::evalGen(void* mem, const T** arg, T** res,
                                      int* iw, T* w) {
    const T* idata0 = arg[0];
    const T* idata = arg[1];
    T* odata = res[0];
  ...
  template<bool Add>
  void SetNonzerosSlice2<Add>::evalD(void* mem, const double** arg, double** res,
                                     int* iw, double* w) {
    evalGen<double>(mem, arg, res, iw, w);
  }

  template<bool Add>
  void SetNonzerosSlice2<Add>::evalSX(void* mem, const SXElem** arg, SXElem** res,
                                      int* iw, SXElem* w) {
    evalGen<SXElem>(mem, arg, res, iw, w);
  }
  ...
  template<bool Add>
  template<typename T>
  void SetNonzerosSlice2<Add>::evalGen(void* mem, const T** arg, T** res,
                                       int* iw, T* w) {
    const T* idata0 = arg[0];
    const T* idata = arg[1];
    T* odata = res[0];
  ...
  spFwd(void* mem, const bvec_t** arg,
  ...
  template<bool Add>
  bool SetNonzerosVector<Add>::zz_is_equal(const MXNode* node, int depth) const {
    // Check dependencies
  ...
  template<bool Add>
  bool SetNonzerosSlice<Add>::zz_is_equal(const MXNode* node, int depth) const {
    // Check dependencies
    if (!this->sameOpAndDeps(node, depth)) return false;
  ...
  template<bool Add>
  bool SetNonzerosSlice2<Add>::zz_is_equal(const MXNode* node, int depth) const {
    // Check dependencies
    if (!this->sameOpAndDeps(node, depth)) return false;
