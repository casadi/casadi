...
namespace casadi {
 ...
 void ConstantMX::evalFwd(const std::vector<cpv_MX>& fseed, const std::vector<pv_MX>& fsens) {
  ...
  void ConstantMX::evalAdj(const std::vector<pv_MX>& aseed, const std::vector<pv_MX>& asens) {
