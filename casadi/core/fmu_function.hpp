...
struct CASADI_EXPORT FmuMemory : public FunctionMemory {
  ...
  // Timing, number of calls
  size_t n_get_all, n_get_directional, n_get_adjoint;
  double t_get_all, t_get_directional, t_get_adjoint;
  // Constructor
...
class CASADI_EXPORT FmuFunction : public FunctionInternal {
 public:
  ...
  bool print_progress_, new_jacobian_, new_forward_, new_hessian_, fd_flip_,
    ...
    enable_forward_jacobian_, enable_adjoint_jacobian_, enable_adjoint_hessian_;
