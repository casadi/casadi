...
/** @} */
    ...
    /// Print scalar
    void printScalar(std::ostream &stream=casadi::csout, bool trailing_newline=true) const;

    /// Print vector-style
    void printVector(std::ostream &stream=casadi::csout, bool trailing_newline=true) const;

    /// Print dense matrix-stype
    void printDense(std::ostream &stream=casadi::csout, bool trailing_newline=true) const;

    /// Print sparse matrix style
    void printSparse(std::ostream &stream=casadi::csout, bool trailing_newline=true) const;
