...
namespace casadi {
  ...
  */
  ...
  public:
    ...
    static MX create(const Sparsity& sp, const MX& x, const Slice& s, const MX& nz_offset);
    static MX create(const Sparsity& sp, const MX& x, const Slice& inner, const Slice& outer, const MX& nz_offset);
    ///@}
  ...
  public:
    ...
    /// Constructor
    GetNonzerosParamSlice(const Sparsity& sp, const MX& x, const Slice& s, const MX& nz_offset) : GetNonzerosParam(sp, x, nz_offset), s_(s) {}
  ...
  class CASADI_EXPORT GetNonzerosParamSlice2 : public GetNonzerosParam {
  public:

    /// Constructor
    GetNonzerosParamSlice2(const Sparsity& sp, const MX& x, const Slice& inner,
                      const Slice& outer,
                      const MX& nz_offset) : GetNonzerosParam(sp, x, nz_offset), inner_(inner), outer_(outer) {}

    /// Destructor
    ~GetNonzerosParamSlice2() override {}
    ...
    /** \brief Deserializing constructor */
    explicit GetNonzerosParamSlice2(DeserializingStream& s);
  };
