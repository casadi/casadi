...
#ifndef CASADI_MODELICA_PARSER_INTERNAL_HPP
#define CASADI_MODELICA_PARSER_INTERNAL_HPP
...
namespace casadi {
  ...
  class CASADI_EXPORT
  ModelicaParserInternal : public SharedObjectInternal,
                           public PluginInterface<ModelicaParserInternal> {
  public:
    // Constructor
    ModelicaParserInternal();
...
#endif // CASADI_MODELICA_PARSER_INTERNAL_HPP
