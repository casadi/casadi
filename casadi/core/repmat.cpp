...
namespace casadi {
  ...
  void HorzRepmat::eval_mx(const std::vector<MX>& arg, std::vector<MX>& res, bool unique) const {
  ...
  void HorzRepsum::eval_mx(const std::vector<MX>& arg, std::vector<MX>& res, bool unique) const {
