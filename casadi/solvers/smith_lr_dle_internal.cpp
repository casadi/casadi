...
namespace casadi {
  ...
  extern "C"
  int CASADI_LRDLE_SMITH_EXPORT
  casadi_register_lrdle_smith(LrDleInternal::Plugin* plugin) {
  ...
  extern "C"
  void CASADI_LRDLE_SMITH_EXPORT casadi_load_lrdle_smith() {
    LrDleInternal::registerPlugin(casadi_register_lrdle_smith);
  }
