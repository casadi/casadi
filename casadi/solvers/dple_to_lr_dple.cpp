...
namespace casadi {
  ...
  extern "C"
  int CASADI_DPLE_LRDPLE_EXPORT
      casadi_register_dple_lrdple(DpleInternal::Plugin* plugin) {
  ...
  extern "C"
  void CASADI_DPLE_LRDPLE_EXPORT casadi_load_dple_lrdple() {
    DpleInternal::registerPlugin(casadi_register_dple_lrdple);
  }
