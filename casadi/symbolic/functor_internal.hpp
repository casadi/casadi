...
namespace casadi{
  ...
  /** \brief Internal class for Callback
      ...
      \date 2013
  */
  class CASADI_EXPORT FunctorInternal : public SharedObjectNode {
  ...
  class CASADI_EXPORT DerivativeGeneratorCInternal : public DerivativeGeneratorInternal, FunctorCInternal<DerivativeGeneratorCPtr> {
    friend class DerivativeGenerator;
  ...
  class CASADI_EXPORT CustomEvaluateCInternal : public CustomEvaluateInternal, FunctorCInternal<CustomEvaluateCPtr> {
    friend class CustomEvaluate;
  ...
  class CASADI_EXPORT CallbackCInternal : public CallbackInternal, FunctorCInternal<CallbackCPtr> {
    friend class Callback;
