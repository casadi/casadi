...
*/
  ...
  */
  ...
  CASADI_SYMBOLIC_EXPORT MX veccat(const std::vector<MX>& comp);

  /** \brief  concatenate vertically while vecing all arguments with vecNZ */
  CASADI_SYMBOLIC_EXPORT MX vecNZcat(const std::vector<MX>& comp);

#ifndef SWIG
  /** \brief  concatenate vertically, two matrices */
  CASADI_SYMBOLIC_EXPORT MX horzcat(const MX& a, const MX& b);

  /** \brief  concatenate horizontally, two matrices */
  CASADI_SYMBOLIC_EXPORT MX vertcat(const MX& a, const MX& b);
#endif // SWIG

  /** \brief  Frobenius norm  */
  CASADI_SYMBOLIC_EXPORT MX norm_F(const MX &x);

  /** \brief  2-norm  */
  CASADI_SYMBOLIC_EXPORT MX norm_2(const MX &x);

  /** \brief 1-norm  */
  CASADI_SYMBOLIC_EXPORT MX norm_1(const MX &x);

  /** \brief Infinity-norm */
  CASADI_SYMBOLIC_EXPORT MX norm_inf(const MX &x);

  /** \brief Transpose an expression */
  CASADI_SYMBOLIC_EXPORT MX transpose(const MX &x);
  ...
  *
  */
  CASADI_SYMBOLIC_EXPORT MX mul(const MX &x, const MX &y, const Sparsity& sp_z=Sparsity());
  ...
  */
  ...
  /** \brief  Take the outer product of two vectors
      ...
      with x and y vectors
  */
  CASADI_SYMBOLIC_EXPORT MX outer_prod(const MX &x, const MX &y);
  ...
  */
  ...
  CASADI_SYMBOLIC_EXPORT MX reshape(const MX &x, int nrow, int ncol);
#endif // SWIG
  ...
  */
  ...
  CASADI_SYMBOLIC_EXPORT MX unite(const MX& A, const MX& B);

  /** \brief  Simplify an expression */
  CASADI_SYMBOLIC_EXPORT void simplify(MX& ex);
  ...
  */
  CASADI_SYMBOLIC_EXPORT MX diag(const MX& x);

  /** \brief   Construct a matrix with given blocks on the diagonal */
  CASADI_SYMBOLIC_EXPORT MX blkdiag(const std::vector<MX> &A);

#ifndef SWIG
  /** \brief   Construct a matrix with given blocks on the diagonal */
  CASADI_SYMBOLIC_EXPORT MX blkdiag(const MX &A, const MX& B);
#endif // SWIG

  /** \brief Return a col-wise summation of elements */
  CASADI_SYMBOLIC_EXPORT MX sumCols(const MX &x);
  ...
  */
  CASADI_SYMBOLIC_EXPORT MX nullspace(const MX& A);

  /** \brief Matrix determinant (experimental) */
  CASADI_SYMBOLIC_EXPORT MX det(const MX& A);

  /** \brief Matrix inverse (experimental) */
  CASADI_SYMBOLIC_EXPORT MX inv(const MX& A);
