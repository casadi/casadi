...
namespace casadi{
  ...
  NLPSolverInternal::NLPSolverInternal(const Function& nlp) : nlp_(nlp){
    ...
    addOption("hess_lag",            OT_Function,       GenericType(),  "Function for calculating the Hessian of the Lagrangian (autogenerated by default)");
    addOption("grad_lag",           OT_Function,       GenericType(),  "Function for calculating the gradient of the Lagrangian (autogenerated by default)");
    addOption("jac_g",              OT_Function,       GenericType(),  "Function for calculating the Jacobian of the constraints (autogenerated by default)");
    addOption("grad_f",             OT_Function,       GenericType(),  "Function for calculating the gradient of the objective (column, autogenerated by default)");
    addOption("jac_f",              OT_Function,       GenericType(),  "Function for calculating the jacobian of the objective (sparse row, autogenerated by default)");
