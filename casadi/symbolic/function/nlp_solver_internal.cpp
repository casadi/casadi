...
namespace casadi{
  ...
  NLPSolverInternal::NLPSolverInternal(const Function& nlp) : nlp_(nlp){
    ...
    addOption("expand_f",           OT_BOOLEAN,  GenericType(),
              "Expand the objective function in terms of scalar operations, i.e. MX->SX. "
              "Deprecated, use \"expand\" instead.");
    addOption("expand_g",           OT_BOOLEAN,  GenericType(),
              "Expand the constraint function in terms of scalar operations, i.e. MX->SX. "
              "Deprecated, use \"expand\" instead.");
    addOption("generate_hessian",   OT_BOOLEAN,  GenericType(),
              "Deprecated option. Generate an exact Hessian of the Lagrangian if not supplied.");
    addOption("generate_jacobian",  OT_BOOLEAN,  GenericType(),
              "Deprecated option. Generate an exact Jacobian of the constraints if not supplied.");
    addOption("generate_gradient",  OT_BOOLEAN,  GenericType(),
              "Deprecated option. Generate a function for calculating "
              "the gradient of the objective.");
    addOption("parametric",         OT_BOOLEAN,  GenericType(),
              "Deprecated option. Expect F, G, H, J to have an additional "
              "input argument appended at the end, denoting fixed parameters.");
    addOption("gauss_newton",       OT_BOOLEAN,  GenericType(),
              "Deprecated option. Use Gauss Newton Hessian approximation");
  ...
  void NLPSolverInternal::init(){
    ...
    casadi_assert_warning(!hasSetOption("expand_f"),
                          "Option \"expand_f\" ignored (deprecated). Use \"expand\" instead.");
    casadi_assert_warning(!hasSetOption("expand_g"),
                          "Option \"expand_g\" ignored (deprecated). Use \"expand\" instead.");
    casadi_assert_warning(!hasSetOption("generate_hessian"),
                          "Option \"generate_hessian\" ignored (deprecated).");
    casadi_assert_warning(!hasSetOption("generate_jacobian"),
                          "Option \"generate_jacobian\" ignored (deprecated).");
    casadi_assert_warning(!hasSetOption("generate_gradient"),
                          "Option \"generate_gradient\" ignored (deprecated).");
    casadi_assert_warning(!hasSetOption("parametric"),
                          "Option \"parametric\" ignored (deprecated).");
    casadi_assert_warning(!hasSetOption("gauss_newton"),
                          "Option \"gauss_newton\" ignored (deprecated).");
