...
CASADI_SYMBOLIC_EXPORT std::string getSchemeEntryName(InputOutputScheme scheme, int i);
CASADI_SYMBOLIC_EXPORT std::string getSchemeEntryDoc(InputOutputScheme scheme, int i);
CASADI_SYMBOLIC_EXPORT std::string getSchemeEntryEnumName(InputOutputScheme scheme, int i);
CASADI_SYMBOLIC_EXPORT int getSchemeEntryEnum(InputOutputScheme scheme, const std::string &name);
