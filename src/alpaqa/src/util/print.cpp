...
template ALPAQA_EXPORT ostream &print_python(ostream &os, const MatrixX<float> &);
template ALPAQA_EXPORT ostream &print_python(ostream &os, const MatrixX<double> &);
template ALPAQA_EXPORT ostream &print_python(ostream &os, const MatrixX<long double> &);
template ALPAQA_EXPORT ostream &print_python(ostream &os, const MatrixX<complex<float>> &);
template ALPAQA_EXPORT ostream &print_python(ostream &os, const MatrixX<complex<double>> &);
template ALPAQA_EXPORT ostream &print_python(ostream &os, const MatrixX<complex<long double>> &);

template ALPAQA_EXPORT ostream &print_python(ostream &os, const VectorX<float> &);
template ALPAQA_EXPORT ostream &print_python(ostream &os, const VectorX<double> &);
template ALPAQA_EXPORT ostream &print_python(ostream &os, const VectorX<long double> &);
template ALPAQA_EXPORT ostream &print_python(ostream &os, const VectorX<complex<float>> &);
template ALPAQA_EXPORT ostream &print_python(ostream &os, const VectorX<complex<double>> &);
template ALPAQA_EXPORT ostream &print_python(ostream &os, const VectorX<complex<long double>> &);
