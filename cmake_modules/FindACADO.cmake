...
FOREACH(LIB ${ACADO_LIBS_LIST})
  ...
  FIND_LIBRARY(ACADO_LIB_${LIB}_s
    NAMES ${LIB}_s
    HINTS ${ACADO_INCLUDE_DIR}/../libs)
  IF(ACADO_LIB_${LIB}_s)
    MESSAGE(STATUS "Found ${LIB}: ${ACADO_LIB_${LIB}_s}")
    SET(ACADO_SHARED_LIBRARIES ${ACADO_SHARED_LIBRARIES} ${ACADO_LIB_${LIB}_s})
  ENDIF(ACADO_LIB_${LIB}_s)
ENDFOREACH(LIB)
